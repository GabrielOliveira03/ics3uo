...
<html lang="en">
  ...
  <body>
    ...
    <?
			...
			$team1[] = ["Flash", "strength" => 2, "speed" => 5, "smarts" => 3, "img" => "flash.png"];
			$team1[] = ["Iron Man", "strength" => 3, "speed" => 4, "smarts" => 4, "img" => "ironman.png"];
			$team1[] = ["Spiderman", "strength" => 3, "speed" => 4, "smarts" => 2, "img" => "spiderman.png"];

			$team2 = [];
			$team2[] = ["Thor", "strength" => 5, "speed" => 2, "smarts" => 2, "img" => "thor.png"];
      $team2[] = ["Hulk", "strength" => 5, "speed" => 2, "smarts" => 1, "img" => "hulk.png"];
      $team2[] = ["Captain America", "strength" => 3, "speed" => 3, "smarts" => 3, "img" => "captain_america.png"];
      $team2[] = ["Cyborg", "strength" => 4, "speed" => 2, "smarts" => 4, "img" => "cyborg.png"];
      $team2[] = ["Wolverine", "strength" => 4, "speed" => 3, "smarts" => 3, "img" => "wolverine.png"];
			...
			if ($_POST['submit']) {
				...
				} else if ($hero1[$chosen_skill] < $hero2[$chosen_skill]) {
					$winner = $hero2[0];
					$figthers_call = "&nbsp;<span class='winner_message'>" . $winner . " wins!</span>";
					$figthers_call .= '<a class="btn pill" href="' . $_SERVER['PHP_SELF'] . '">Try again</a>';
				} else if ($hero1[$chosen_skill] == $hero2[$chosen_skill]) {
					$figthers_call = "&nbsp;<span>It's a tie! Both heroes have an equal level of " . $chosen_skill . "!</span>";
					$figthers_call .= '<a class="btn pill" href="' . $_SERVER['PHP_SELF'] . '">Try again</a>';
				}
